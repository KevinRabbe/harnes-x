...
class EventType(StrEnum):
    ...
    CODING_PHASE_CHANGED = "coding_phase_changed"
    CODING_PLAN_UPDATED = "coding_plan_updated"
    CODING_COMMITMENT_CHANGED = "coding_commitment_changed"
    CODING_PROGRESS_ASSESSED = "coding_progress_assessed"
