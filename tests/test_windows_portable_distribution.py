...
def test_manifest_rejects_escape_duplicate_and_self_inventory() -> None:
...
def test_distribution_cli_build_and_verify(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    root = _fixture_distribution(tmp_path)
